...
Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of one reactant.
    ...
    <Function key="Function_44" name="Rate Law 1 substrate 1 modifier_1" type="UserDefined" reversible="false">
      <Expression>
        unwinding_rate*dsDNA*MG_094_HEXAMER
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_335" name="MG_094_HEXAMER" order="0" role="modifier"/>
        <ParameterDescription key="FunctionParameter_308" name="dsDNA" order="1" role="substrate"/>
        <ParameterDescription key="FunctionParameter_306" name="unwinding_rate" order="2" role="constant"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_46" name="Function for leading strand polymerisation_1_1" type="UserDefined" reversible="false">
      <Expression>
        Lead_polymerisation_rate*leadSsDNA*MG_250_MONOMER*DNA_POLYMERASE_CORE_BETA_CLAMP_GAMMA_COMPLEX
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_328" name="DNA_POLYMERASE_CORE_BETA_CLAMP_GAMMA_COMPLEX" order="0" role="modifier"/>
        <ParameterDescription key="FunctionParameter_333" name="Lead_polymerisation_rate" order="1" role="constant"/>
        <ParameterDescription key="FunctionParameter_330" name="MG_250_MONOMER" order="2" role="modifier"/>
        <ParameterDescription key="FunctionParameter_332" name="leadSsDNA" order="3" role="substrate"/>
      </ListOfParameterDescriptions>
    </Function>
  </ListOfFunctions>
  <Model key="Model_7" name="Replication" simulationType="time" timeUnit="dimensionless" volumeUnit="dimensionless" areaUnit="m²" lengthUnit="m" quantityUnit="#" type="stochastic" avogadroConstant="6.02214179e+23">
    <MiriamAnnotation>
<rdf:RDF
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Compartment_5">
    ...
    <ListOfMetabolites>
      <Metabolite key="Metabolite_73" name="dsDNA bp" simulationType="reactions" compartment="Compartment_5">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_73">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_69" name="Helicase" simulationType="reactions" compartment="Compartment_5">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_69">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_65" name="leading ssDNA base" simulationType="reactions" compartment="Compartment_5">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_65">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_61" name="lagging ssDNA base" simulationType="reactions" compartment="Compartment_5">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_61">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_57" name="ligase" simulationType="reactions" compartment="Compartment_5">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_57">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_53" name="core subunit" simulationType="reactions" compartment="Compartment_5">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_53">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_49" name="beta-clamp" simulationType="reactions" compartment="Compartment_5">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_49">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_45" name="primase" simulationType="reactions" compartment="Compartment_5">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_45">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_41" name="gamma complex" simulationType="reactions" compartment="Compartment_5">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_41">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_95" name="leading dsDNA bp with a break" simulationType="reactions" compartment="Compartment_5">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_95">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_97" name="lagDsDNA bp" simulationType="reactions" compartment="Compartment_5">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_97">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_99" name="DNA polymerase III" simulationType="reactions" compartment="Compartment_5">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_99">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_101" name="DnaA-ATP complex" simulationType="reactions" compartment="Compartment_5">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_101">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_103" name="Complete DNA" simulationType="reactions" compartment="Compartment_5">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#ModelValue_12">
    ...
    <ListOfReactions>
      <Reaction key="Reaction_25" name="unwinding" reversible="false" fast="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_25">
    <dcterms:created>
      ...
      <Reaction key="Reaction_23" name="leading strand polymerisation" reversible="false" fast="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_23">
    <dcterms:created>
      ...
      <Reaction key="Reaction_22" name="Polymerase complex creation" reversible="false" fast="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_22">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4040" name="k1" value="0"/>
        </ListOfConstants>
    ...
    <ListOfEvents>
      <Event key="Event_0" name="termination" fireAtInitialTime="0" persistentTrigger="0">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Event_0">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2015-03-12T06:37:22Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
  </rdf:Description>
</rdf:RDF>
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=Replication,Vector=Values[Lag_ligation_rate]" value="0.004" type="ModelValue" simulationType="fixed"/>
          ...
          <ModelParameter cn="CN=Root,Model=Replication,Vector=Values[Lead_polymerisation_rate]" value="10" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Replication,Vector=Values[okazaki_polymerisation_rate]" value="10" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Replication,Vector=Values[polymerase_complex_creation_rate]" value="0.1" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Replication,Vector=Values[ssb_binding_rate]" value="0.1" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Replication,Vector=Values[SSB_transformation_rate]" value="0.1" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Replication,Vector=Values[terminal_lag_ligation_rate]" value="0.004" type="ModelValue" simulationType="fixed"/>
          ...
          <ModelParameter cn="CN=Root,Model=Replication,Vector=Values[unwinding_rate]" value="0.000173" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Replication,Vector=Values[Lead_ss_dna_block_rate]" value="10" type="ModelValue" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          <ModelParameterGroup cn="CN=Root,Model=Replication,Vector=Reactions[unwinding]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Replication,Vector=Reactions[unwinding],ParameterGroup=Parameters,Parameter=unwinding_rate" value="0.000173" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=Replication,Vector=Reactions[leading strand polymerisation]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Replication,Vector=Reactions[leading strand polymerisation],ParameterGroup=Parameters,Parameter=Lead_polymerisation_rate" value="10" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
  ...
  <SBMLReference file="lead_strand.xml">
    <SBMLMap SBMLid="Complete_DNA" COPASIkey="Metabolite_103"/>
    <SBMLMap SBMLid="DNA_POLYMERASE_CORE" COPASIkey="Metabolite_53"/>
    <SBMLMap SBMLid="DNA_POLYMERASE_CORE_BETA_CLAMP_GAMMA_COMPLEX" COPASIkey="Metabolite_99"/>
    <SBMLMap SBMLid="DNA_POLYMERASE_GAMMA_COMPLEX" COPASIkey="Metabolite_41"/>
    <SBMLMap SBMLid="DnaA_ATP_complex" COPASIkey="Metabolite_101"/>
    <SBMLMap SBMLid="Function_for_leading_strand_polymerisation_1_1" COPASIkey="Function_46"/>
    ...
    <SBMLMap SBMLid="MG_001_DIMER" COPASIkey="Metabolite_49"/>
    <SBMLMap SBMLid="MG_094_HEXAMER" COPASIkey="Metabolite_69"/>
    <SBMLMap SBMLid="MG_250_MONOMER" COPASIkey="Metabolite_45"/>
    <SBMLMap SBMLid="MG_254_MONOMER" COPASIkey="Metabolite_57"/>
    <SBMLMap SBMLid="Rate_Law_1_substrate_1_modifier_1_0" COPASIkey="Function_44"/>
    <SBMLMap SBMLid="SSB_transformation_rate" COPASIkey="ModelValue_16"/>
    <SBMLMap SBMLid="default" COPASIkey="Compartment_5"/>
    <SBMLMap SBMLid="dsDNA" COPASIkey="Metabolite_73"/>
    <SBMLMap SBMLid="lagDsDNA" COPASIkey="Metabolite_97"/>
    <SBMLMap SBMLid="lagSsDNA" COPASIkey="Metabolite_61"/>
    <SBMLMap SBMLid="leadDsDNA" COPASIkey="Metabolite_95"/>
    <SBMLMap SBMLid="leadSsDNA" COPASIkey="Metabolite_65"/>
    ...
    <SBMLMap SBMLid="re20" COPASIkey="Reaction_25"/>
